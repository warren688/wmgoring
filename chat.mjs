...
//
// IMPORTANT: this file must be named chat.mjs (not chat.js). The .mjs
// extension tells Node to treat it as a modern ES module regardless of any
// other project config — without it, the import/export syntax below fails
// to parse and the function silently fails to deploy.
//
